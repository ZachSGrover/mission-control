...
export type QcSchedulerStatus = {
  ...
  daily_qc_source_mode: string;
  onlymonster_readonly_enabled: boolean;
  onlyfans_readonly_enabled: boolean;
  platform_write_enabled: boolean;
  safe_mode: boolean;
  ...
  last_source_confidence: string | null;
